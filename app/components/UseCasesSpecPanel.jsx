...
export function getUseCaseLabels(t) {
  return {
    ...
    phDescription: t('useCasesSpec.phDescription'),
    phTitle: t('useCasesSpec.phTitle'),
    phActor: t('useCasesSpec.phActor'),
    phObject: t('useCasesSpec.phObject'),
    phPre: t('useCasesSpec.phPre'),
    phPost: t('useCasesSpec.phPost'),
    phActorAction: t('useCasesSpec.phActorAction'),
    phSystemResponse: t('useCasesSpec.phSystemResponse'),
