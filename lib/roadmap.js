...
/**
 * Products shown in the /cases filter chips. DV (Deviante) + MB (Milebrick) —
 * owner is now authoring Milebrick UCs (11/08/2026). Portfolio (IO) was dropped
 * from the UC surface by owner request (it had no cases anyway).
 */
export const ACTIVE_GESTALT_PRODUCT_CODES = ['DV', 'MB']
