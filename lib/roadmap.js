...
/**
 * Products shown in the /cases filter chips. IO + DV are the active build
 * scope (gestalt-kit/partials/active-scope.md); MB (Milebrick) is listed by
 * owner request even though it has no cases yet — the chip surfaces it.
 */
export const ACTIVE_GESTALT_PRODUCT_CODES = ['IO', 'DV', 'MB']
